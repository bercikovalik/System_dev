...
public partial class Dnn972Context : DbContext
{
    public Dnn972Context()
    {
    }

    public Dnn972Context(DbContextOptions<Dnn972Context> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<RecipeProductLink> RecipeProductLinks { get; set; }
    ...
    public virtual DbSet<TegnapraKvTask> TegnapraKvTasks { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Data Source=rendfejl10004.northeurope.cloudapp.azure.com,1433;Initial Catalog=Dnn972;User ID=tkvSql;Password=Kifli123;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AspnetApplication>(entity =>
        {
            entity.HasKey(e => e.ApplicationId)
                .HasName("PK__aspnet_A__C93A4C98D48E6C09")
                .IsClustered(false);

            entity.ToTable("aspnet_Applications");

            entity.HasIndex(e => e.LoweredApplicationName, "UQ__aspnet_A__17477DE4A6C828C0").IsUnique();

            entity.HasIndex(e => e.ApplicationName, "UQ__aspnet_A__309103319688DE38").IsUnique();
        ...
        modelBuilder.Entity<AspnetMembership>(entity =>
        {
            entity.HasKey(e => e.UserId)
                .HasName("PK__aspnet_M__1788CC4D2E94569F")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => new { e.Feature, e.CompatibleSchemaVersion }).HasName("PK__aspnet_S__5A1E6BC16CF452AD");
        ...
        {
            entity.HasKey(e => e.UserId)
                .HasName("PK__aspnet_U__1788CC4D33D60C02")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => e.Ingredientid).HasName("PK__INGREDIE__D9E75423BB9C17CF");
        ...
        {
            entity.HasKey(e => e.Ingredientproductid).HasName("PK__INGREDIE__168B229E638F6736");

            entity.ToTable("INGREDIENTPRODUCTS");

            entity.Property(e => e.Ingredientproductid).HasColumnName("INGREDIENTPRODUCTID");
            entity.Property(e => e.Ingredientid).HasColumnName("INGREDIENTID");
            entity.Property(e => e.Productid).HasColumnName("PRODUCTID");
            entity.Property(e => e.RewriteUrl)
                .HasMaxLength(255)
                .HasColumnName("rewriteUrl");

            entity.HasOne(d => d.Ingredient).WithMany(p => p.Ingredientproducts)
                .HasForeignKey(d => d.Ingredientid)
                .HasConstraintName("FK__INGREDIEN__INGRE__143CDA05");
        });
        ...
        {
            entity.HasKey(e => e.ProductTypeId).HasName("PK__PRODUCT___A1312F4EE7145983");
        ...
        {
            entity.HasKey(e => e.Recipeid).HasName("PK__RECIPES__D11EC800A3F9B137");

            entity.ToTable("RECIPES");

            entity.HasIndex(e => e.Name, "UQ_RECIPE_NAME").IsUnique();
        ...
        modelBuilder.Entity<RecipeProductLink>(entity =>
        {
            entity.HasKey(e => e.RecipeProductLinkId).HasName("PK__RECIPE_P__850781C7FEBD2F11");

            entity.ToTable("RECIPE_PRODUCT_LINKS");

            entity.Property(e => e.RecipeProductLinkId).HasColumnName("RecipeProductLinkID");
            entity.Property(e => e.ProductName).HasMaxLength(255);
            entity.Property(e => e.ProductTypeId).HasColumnName("ProductTypeID");
            ...
            entity.HasOne(d => d.ProductType).WithMany(p => p.RecipeProductLinks)
                .HasForeignKey(d => d.ProductTypeId)
                .HasConstraintName("FK_ProductType");

            entity.HasOne(d => d.Recipe).WithMany(p => p.RecipeProductLinks)
        ...
        {
            entity.HasKey(e => e.Recipeingredientid).HasName("PK__RECIPEIN__B83FF42CF7A62516");
            ...
            entity.HasOne(d => d.Ingredient).WithMany(p => p.Recipeingredients)
                .HasForeignKey(d => d.Ingredientid)
                .HasConstraintName("FK__RECIPEING__INGRE__106C4921");

            entity.HasOne(d => d.Recipe).WithMany(p => p.Recipeingredients)
                .HasForeignKey(d => d.Recipeid)
                .HasConstraintName("FK__RECIPEING__RECIP__0F7824E8");
        });
        ...
        modelBuilder.Entity<TegnapraKvTask>(entity =>
        {
            entity.HasKey(e => e.TaskId).HasName("PK_dbo.TegnapraKV_Tasks");

            entity.ToTable("TegnapraKV_Tasks");
